...
- **X_RDK_Refresh Parameter**: Trigger-based parameter that forces interface status refresh and HAL synchronization when set to true
- **X_RDK_BaseInterface Parameter**: Platform-specific interface mapping for hardware abstraction and multi-port device support  
- **X_RDK_Marking Table**: Dynamic QoS marking configuration for advanced traffic engineering and service differentiation
