...
- **Parameter Registration**: Parameters are registered via RBus message bus for real-time event publication
...
| Message Bus Interface | Abstraction layer for RBus and IPC communications, providing unified interfaces for event publication, parameter registration, and inter-process messaging. | `ssp_messagebus_interface.c`, `ssp_messagebus_interface.h` |
