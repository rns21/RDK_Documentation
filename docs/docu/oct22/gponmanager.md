...
| CCSP P&M | TR-181 parameter management and data model operations | DBus Method Calls | CCSP DML Protocol | Request-Response | `GetParameterValues()`, `SetParameterValues()`, `GetParameterNames()` |
